...
int main(void)
{
  ...
  Lcd_PortType ports[] = { GPIOA, GPIOA, GPIOA, GPIOA };
     ...
     Lcd_cursor(&lcd, 0,1);
     Lcd_string(&lcd, "Abdullah R");
     Lcd_cursor(&lcd, 1,1);
     Lcd_string(&lcd, "212223230004");
  /* USER CODE END 2 */
...
![image](https://github.com/user-attachments/assets/23dab39c-c642-4815-a9f8-05652b133bbf)
 ...
 ![image](https://github.com/user-attachments/assets/8db62f15-d412-4de6-ab38-eb2336c355aa)
